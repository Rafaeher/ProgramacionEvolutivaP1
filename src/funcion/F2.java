...
public class F2<GenotipoF extends Genotipo> extends Funcion<GenotipoF, FenotipoReal, Double> {
	
	private boolean maximizar = false;
	
	public F2(ArrayList<Individuo<GenotipoF, FenotipoReal, Double>> poblacion, Configuracion configuracion) {
