...
public class F3 <GenotipoF extends Genotipo> extends Funcion<GenotipoF, FenotipoReal, Double> {	

	private boolean maximizar = true;
	
	public F3(ArrayList<Individuo<GenotipoF, FenotipoReal, Double>> poblacion, Configuracion configuracion) {
